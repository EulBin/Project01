<%@ page import="adminmember.AdminMemberDTO"%>
<%@ page import="adminmember.AdminMemberDAO"%> 
...
//JDBC를 통해 오라클 접속
AdminMemberDAO dao = new AdminMemberDAO(oracleDriver, oracleURL, oracleId, oraclePwd);
//받아온 아이디, 패스워드를 매개변수로 메서드 호출. 일치하는 회원정보가 있는지 확인함.
AdminMemberDTO memberDTO = dao.getMemberDTO(userId, userPwd);
//DB작업이 끝나면 자원해제
dao.close();
